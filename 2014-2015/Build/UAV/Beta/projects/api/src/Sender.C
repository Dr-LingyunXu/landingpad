...
int main(int argc, char **argv)
{
   ...
   */
//  ros::Publisher gps_pub = n.advertise<sensor_msgs::NavSatFix>("GPSData", 1000);
  ros::Publisher gps_pub = n.advertise<sensor_msgs::NavSatFix>("GPSStream", 1000);
...
//  ros::Publisher cv_pub = n.advertise<std_msgs::String>("CVData", 1000);
  ...
  while (ros::ok())
  {
    ...
    navMsg.latitude = 0.00;
    navMsg.longitude = -1.0;
    navMsg.altitude = 100;
