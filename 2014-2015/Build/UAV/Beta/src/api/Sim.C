 ...
 *
 * @par Description:
 * Callback for simulation info consolidation.
 *
 ...
 *
 * @par Description:
 * Setup for middleman that is the sim node.
 *
...
int main(int argc, char **argv)
{
  ...
  // subscribe
  ros::Subscriber sub = sim.subscribe("sim", 1000, simCallback);
