...
if("TRUE" STREQUAL "TRUE")
  set(rosapi_SOURCE_PREFIX /home/cracker/workspace/src/rosbridge_suite/rosapi)
  set(rosapi_DEVEL_PREFIX /home/cracker/workspace/devel)
  set(rosapi_INSTALL_PREFIX "")
  set(rosapi_PREFIX ${rosapi_DEVEL_PREFIX})
else()
  set(rosapi_SOURCE_PREFIX "")
  set(rosapi_DEVEL_PREFIX "")
  set(rosapi_INSTALL_PREFIX /home/cracker/workspace/install)
...
if(NOT "/home/cracker/workspace/devel/include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rosapi' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cracker/workspace/src/rosbridge_suite/rosapi/${idir}'.  Ask the maintainer 'Russell Toris <rctoris@wpi.edu>, Jihoon Lee <jihoonlee.in@gmail.com>' to fix it.")
    endif()
