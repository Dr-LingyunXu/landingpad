...
\begin{center} \includegraphics[width=.5\textwidth]{circles.png} \end{center}
...
\caption{Linear, gradient-descent Sarsa($\lambda$) with binary features and $\epsilon$-greedy policy}          % give the algorithm a caption
